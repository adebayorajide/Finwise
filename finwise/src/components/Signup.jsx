    ...
    <div className="flex items-center justify-center flex-col w-auto h-full bg-finwise-green">
      ...
      <div className="flex flex-col justify-center bg-finwise-white h-full w-full border-radius ">
        <div className="flex flex-col w-auto justify-center items-center ">
          ...
          <div className="m-8">
            <button className="bg-finwise-green rounded-b-full rounded-t-full items-center text-center px-32 py-4 text-xl font-semibold leading-6 mt-2">
              Sign Up
            </button>
          </div>
          ...
          <section className="mb-6">
            ...
            <a href="" className="text-blue-900" onClick={() => goToLoginPage()}>
              Log in
            </a>
          </section>
        </div>
